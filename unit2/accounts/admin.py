...
class ResetPasswordDataAdmin(admin.ModelAdmin):
    list_display = ['user', 'create_date', 'expiration_date', 'changed',]
    list_filter = ['changed',]
    search_fields = ['user__email',]


admin.site.register(User, UserAdmin)
admin.site.register(ResetPasswordData, ResetPasswordDataAdmin)